            ...
            <div id="containers">
                ...
                <div id="tabPane4">
                    ...
                    <article class="projects">
                        ...
                        <span><a href="projects/processing/earth.html"><img src="projects/processing/images/earth.JPG"
                                    width="250" height="250" alt="Earth and the moon."></a>
                            <img id="icon" src="projects/processing/images/p5js.png" width="50" height="50"
                                alt="P 5 dot j s.">
                            <p>A view of the Earth and the moon to scale</p>
                        </span>
                        <span><a href="projects/processing/jupiter.html"><img
                                    src="projects/processing/images/jupiter.JPG" width="250" height="250"
                                    alt="Jupiter and its first four moons."></a>
                            <img id="icon" src="projects/processing/images/p5js.png" width="50" height="50"
                                alt="P 5 dot j s.">
                            <p>Jupiter and the four Galilean moons (Scaled for visibility). Earth to scale</p>
                        </span>
                        <span><a href="projects/processing/moon.html"><img src="projects/processing/images/moon.JPG"
                                    width="250" height="250" alt="Earth from the moon's perspective."></a>
                            <img id="icon" src="projects/processing/images/p5js.png" width="50" height="50"
                                alt="P five dot j s.">
                            <p>A sketch showing what the Earth might look like from just past the dark side of the moon
                            </p>
                        </span>
                        <span><img src="projects/processing/images/website.JPG" width="250" height="250"
                                alt="This website.">
                ...
                <div id="tabPane3">
                    <iframe src="https://docs.google.com/viewer?srcid=1FS1YJyMRbbHh4D3jCmclYxLoQ2yDyKOE&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="100%" height="1100px" border:none></iframe>
                </div>
                <!--
                <div id="tabPane5">
                    <h3>tl;dr</h3>
